...
import (
	"code.as/embedas/embed-api/providers/embedly/extract"
	"encoding/json"
	"errors"
	"fmt"
	"io/ioutil"
...
func (c *Client) Extract(urls []string, options extract.Options) ([]Response, error) {
...
func (c *Client) ExtractOne(url string, options extract.Options) (*Response, error) {
